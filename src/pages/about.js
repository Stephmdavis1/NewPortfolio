  ...
  return (
    ...
    <div className='grid w-full grid-cols-8'>
      <div className='col-span-5 flex flex-col items-start justify-start'>
        ...
        <p className='font-medium mt-4 text-sm md:text-md lg:text-lg '>I'm happiest when I'm creating, learning and thinking of ways to help make things better. I have a bachelors in Exercise Science, a Certificate of Web Development and a Google Cert in UX Design. When I'm not behind a computer, you can find me in the gym, trying to buy a new plant for my house (#plantmom) or living it up outdoors!</p>
...
{/* 
  ...
  <div className='col-span-3 flex flex-col items-end justify-start'>
    ...
    <div className='flex flex-col text-right items-end justify-center mb-5'>
      <span className='inline-block text-3xl lg:text-5xl font-bold dark:text-primary'>
      <AnimatedNumbers value={2} />+
      </span>
      <h3 className='text-[10px] md:text-md lg:text-lg font-medium !text-right !items-end capitalize text-dark/75 dark:text-light/75'>Years Front End Exp</h3>
    </div>
    ...
    <div className='flex flex-col items-end justify-center my-5'>
      ...
      <h3 className='text-[10px] md:text-md lg:text-lg font-medium capitalize text-dark/75 dark:text-light/75'>Years UX Exp</h3>
    </div>
    ...
    <div className='flex flex-col items-end justify-center mt-5'>
      ...
      <h2 className='text-[10px] md:text-md lg:text-lg font-medium capitalize text-dark/75 dark:text-light/75'>Projects Completed</h2>
    </div>
