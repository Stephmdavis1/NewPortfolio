...
{/* 
  ...
  <div className='col-span-3 flex flex-col items-end justify-start'>
    ...
    <div className='flex flex-col !text-right items-end justify-center mb-5'>
      ...
      <h3 className='text-xs md:text-md lg:text-lg font-medium !text-right !items-end capitalize text-dark/75 dark:text-light/75'>Years Front End Experience</h3>
    </div>
    ...
    <div className='flex flex-col items-end justify-center my-5'>
      ...
      <h3 className='text-xs md:text-md lg:text-lg font-medium capitalize text-dark/75 dark:text-light/75'>Years UX Experience</h3>
    </div>
