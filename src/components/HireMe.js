...
const HireMe = () => {
  return (
    <div className='w-24 h-24  lg:w-40 lg:h-40 right-6 md:right-0 bottom-0 md:bottom-64 lg:bottom-0 flex items-center justify-center overflow-hidden absolute'>
